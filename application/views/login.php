...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            ...
            <center><img src="<?= base_url('assets/logo/').$row['logo'] ?>" alt="" class="img-responsive" width="50%"
                    style="margin-bottom: 15px"></center>
        ...
        <div class="login-box-body">
            ...
            <form action="<?= base_url('index.php/home/auth') ?>" method="POST">
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" name="jawaban"
                        value="<?= $this->session->userdata('captcha') ?>" placeholder="Hitung angka diatas">
                </div>
                <div class="row">
                    <div class="col-xs-8">
